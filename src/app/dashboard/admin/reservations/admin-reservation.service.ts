...
export interface ReviewCodeRow {
  ...
  issuerUpline: { username: string; name: string; holderUsername: string | null; chain: Array<{ username: string; name: string }> } | null;
  recordedBy: { username: string; name: string } | null;
}
